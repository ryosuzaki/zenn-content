...
勉強中の方は是非、参考になったURLや説明を追加してみてください。
...
変更が終わったら、Commit changes... ボタンを押して、Extended descriptionに何を変更したかを書いたら、Propose Changesをクリックして完了。
...
# 参考になる受験記
出題傾向をまとめたサイト。勉強の配分を考えるのに非常に役に立つので、章の後ろに出題頻度を書き加えた。
